...
import { ActivitySquare, Check, Copy, Crop, Download, Image as ImageIcon, Link2, Loader2, Maximize2, RotateCcw, Upload } from 'lucide-react';
      ...
      <MotionGlassCard>
        ...
        <GlassCard className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Resize, convert, and optimize images. Drag & drop, paste (Ctrl/Cmd+V), or use the upload button.</p>
          </div>
          ...
          <CardContent className="grid gap-6 lg:grid-cols-2">
            ...
            <div
              ...
              <div className="pointer-events-none flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">PNG, JPEG, WEBP, GIF, SVG (rasterized)</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Contain keeps all content; Cover fills the box.</p>
                </div>
        ...
        <GlassCard className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Estimated output size depends on content & quality settings.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-6 md:grid-cols-2">
            {/* Estimated box */}
            <div className="space-y-3">
              <div className="rounded-lg border p-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    Format: <span className="ml-1 font-medium text-foreground">{fmt.toUpperCase()}</span>
                  </div>
                </div>
              </div>
              ...
              <ul className="list-disc space-y-1 pl-5 text-xs text-muted-foreground">
                ...
                <li>
                  Use <span className="font-medium">Contain</span> to keep the full image without cropping.
                </li>
