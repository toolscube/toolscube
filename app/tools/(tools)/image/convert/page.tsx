...
import { Check, Copy, Download, FileType2, Image as ImageIcon, Loader2, Palette, RotateCcw, Upload } from 'lucide-react';
      ...
      <MotionGlassCard>
        ...
        <GlassCard className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Convert images between PNG, JPEG, and WEBP. Drag & drop, paste (Ctrl/Cmd+V), or click to upload.</p>
          </div>
          ...
          <CardContent className="grid gap-6 lg:grid-cols-2">
            ...
            <div
              ...
              <div className="pointer-events-none flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">PNG, JPEG, WEBP, GIF, SVG (SVG/GIF will be rasterized)</p>
              </div>
            </div>
        ...
        <GlassCard className="shadow-sm">
          ...
          <CardContent className="grid gap-6 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">WEBP is usually the smallest. PNG is best for UI/graphics.</p>
            </div>
            ...
            {fmt === 'jpeg' && (
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Input aria-label="Background hex" value={bg} onChange={(e) => setBg(e.target.value)} className="w-36" placeholder="#ffffff" />
                </div>
                <p className="text-xs text-muted-foreground">Used only when the source has transparency.</p>
              </div>
            )}
          </CardContent>
        </GlassCard>
