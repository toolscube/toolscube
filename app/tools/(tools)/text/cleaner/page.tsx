...
export const metadata = buildMetadata({
  ...
  description:
    "Remove extra spaces, emojis, HTML, punctuation, diacritics, or unwanted characters from your text. Normalize, clean, and format text instantly with this free online text cleaner.",
...
export default function Page() {
  const jsonLd = {
    ...
    operatingSystem: "Web",
    description:
      "Free online text cleaner tool to remove spaces, emojis, HTML tags, punctuation, diacritics, and more. Quickly normalize and format text for clean results.",
