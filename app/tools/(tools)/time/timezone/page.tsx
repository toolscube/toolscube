...
export const metadata = buildMetadata({
  ...
  description:
    "Convert time across cities and countries with ease. Instantly compare different time zones and copy/share results.",
...
export default function Page() {
  ...
  const jsonLd = {
    ...
    operatingSystem: "Web",
    description:
      "Convert time between different cities and time zones. Easily copy and share converted times.",
