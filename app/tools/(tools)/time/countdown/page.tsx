...
export const metadata = buildMetadata({
  ...
  description: 'Create quick countdowns, Pomodoro cycles, or event timers. Local save, sound alerts, and a clean multi-timer dashboard.',
...
export default function Page() {
  ...
  const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'Start quick timers, Pomodoro sets, or countdown to a date/time. Lightweight, local-first, and delightful to use.',
